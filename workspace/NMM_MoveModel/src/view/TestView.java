...
public class TestView extends JPanel implements Observer {
	...
	private TestRigInterface model;

	
	
	public TestView(TestRigInterface model){
		super();
		setOpaque(false);
		setSize(800,650);
	...
	public void paint(Graphics g){
		g.drawString("   Number of Games Played:" + model.getNumberOfGamesPlayed(), 25, 200);
		g.drawString("Number of Games Remaining: " + model.getNumberOfGamesToPlay(), 25, 250);
