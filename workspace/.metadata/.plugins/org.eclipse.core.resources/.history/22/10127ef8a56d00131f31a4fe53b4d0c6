...
public class SetupView2 extends JPanel implements ActionListener{
	...
	public SetupView2(ActionListener a, List<PlayerInterface> players12, List<PlayerInterface> players22) {
		super();
		setOpaque(false);
		setSize(800,600);
		...
		for (PlayerInterface p : players12) {
			playerOneSelect.addItem(p.getName());
		}
		
		for (PlayerInterface p : players22) {
