...
public class GameController2 {
	...
	private class HumanMouseListener implements MouseListener {
		...
		public void mouseClicked(MouseEvent e) {
			if(phase.equals(Phase.ONE) || result == 1 || result == -2 || phase.equals(Phase.THREE)){
				int x = e.getX();
				int y = e.getY();
				System.out.println("Clicking");
				int position = findNodeClicked(x, y);
				if(p1 instanceof Human2 && p1.getTokenColour() == turn && position != -1){	
					System.out.println("In if");
					if(phase.equals(Phase.ONE) && (result == -1 || result == -2 || result == 0)){
						result = mc.addToken(p1.getTokenColour(), position);
						if(result != -1){
							gs.lowerPlayerOneCount();
							gs.addToken(p1.getTokenColour(), position);
						}
						if(result == 1){
							mill = true;
						}
					}else if(mill && (result == -1 || result == 1)){
						result = mc.removeToken(p1.getTokenColour(), position);
						if(result != -1){
							gs.removeToken(position);
							mill = false;
						}
					}
				} else if(p2 instanceof Human2 && p2.getTokenColour() == turn && position != -1){	
					System.out.println("In if");
					if(phase.equals(Phase.ONE) && (result == -1 || result == -2 || result == 0)){
						result = mc.addToken(p2.getTokenColour(), position);
						if(result != -1){
							gs.lowerPlayerTwoCount();
							gs.addToken(p2.getTokenColour(), position);
						}
						if(result == 1){
							mill = true;
						}
					}else if(mill && (result == -1 || result == 1)){
						result = mc.removeToken(p2.getTokenColour(), position);
						if(result != -1){
							gs.removeToken(position);
							mill = false;
						}
		...
		public void mouseReleased(MouseEvent e) {
			...
			if((phase.equals(Phase.TWO) || phase.equals(Phase.THREE)) && (result == 0 || result == -1)){
				...
				if((p1 instanceof Human2 && p1.getTokenColour() == turn) && (firstNode != -1 && secondNode != -1)){
				...
				} else if((p2 instanceof Human2 && p2.getTokenColour() == turn) && (firstNode != -1 && secondNode != -1)){	
					System.out.println("Above to move");
					if(result == -1 || result == 0){
